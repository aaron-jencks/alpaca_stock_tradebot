...
# This is the section for file io configuration
...
# This is the section for data configuration

date_format = "%Y-%m-%d/%H:%M:%S"               # This is the format that all datetime strings will take in the data.
